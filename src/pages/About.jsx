...
export default function About() {
  return (
    <div className="bg-[#f8f1e9] text-[#3b3b3b] pt-16 pb-20 px-4 md:px-8">
      ...
      {/* Left: Image with jump animation */}
      <motion.div
      ...
      {/* Right: Text with right-to-left animation */}
      <motion.div
        className="md:w-1/2 w-full pt-16"
      ...
      {/* Animated heading */}
      <motion.h2
        className="text-3xl font-semibold text-[#2d2d2d]"
      ...
      <div className="flex flex-col md:flex-row gap-10 items-center">
        ...
        {/* Text block slides right to left */}
        <motion.div
          className="md:w-1/2 w-full space-y-4"
          initial={{ x: 50, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          ...
          viewport={{ once: false, amount: 0.3 }}
        >
          <h2 className="text-3xl font-semibold text-[#2d2d2d] mb-4">Brand Identity</h2>
          <p className="text-base leading-7">
        ...
        <section className="py-10 text-center"> {/* py-10 for internal section padding */}
         <motion.h2
          className="text-4xl font-serif text-gray-800 mb-10"
...
>
  ...
  <p className="text-base text-gray-600">
    Please Fill Out Our Contact Form, We Will Get Back To You As Soon As Possible.
         ...
         <motion.form
  className="max-w-3xl mx-auto bg-white p-8 rounded shadow-lg grid grid-cols-1 md:grid-cols-2 gap-6"
  initial={{ y: 40, opacity: 0 }}
  whileInView={{ y: 0, opacity: 1 }}
  transition={{ duration: 0.8, ease: "easeOut" }}
  viewport={{ once: false, amount: 0.3 }}
>
  <div className="md:col-span-1">
    <label htmlFor="fullName" className="block text-left text-sm font-medium text-gray-700 mb-2">
      Full Name
    </label>
    <input
      type="text"
  ...
  <div className="md:col-span-1">
    <label htmlFor="emailAddress" className="block text-left text-sm font-medium text-gray-700 mb-2">
      E-Mail Address
    </label>
    <input
      type="email"
  ...
  <div className="md:col-span-1">
    <label htmlFor="phoneNumber" className="block text-left text-sm font-medium text-gray-700 mb-2">
      Phone Number
    </label>
    <input
      type="tel"
  ...
  <div className="md:col-span-1">
    <label htmlFor="subject" className="block text-left text-sm font-medium text-gray-700 mb-2">
      Subject
    </label>
    <select
      id="subject"
      className="w-full p-3 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-yellow-700 appearance-none bg-white pr-8"
    >
